...
public class AccountDB
{
    ...
    public Set<MyTransaction> getAllMyTransactionsByID(int account_id)
    {
        ...
        {
            tx = currentSession().beginTransaction();
            Account account = (Account) currentSession().get(Account.class, new Long(account_id));
    ...
    public String getAccountCurrencyName(int accountId)
    {
        ...
        {
            tx = currentSession().beginTransaction();
            Account account = (Account) currentSession().get(Account.class, new Long(accountId));
